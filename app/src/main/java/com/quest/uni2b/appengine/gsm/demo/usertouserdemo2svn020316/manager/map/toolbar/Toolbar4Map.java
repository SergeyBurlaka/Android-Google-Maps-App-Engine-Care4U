...
public abstract  class Toolbar4Map {
    ...
    public abstract void createFaces(ToolbarFacesState state) ;

    abstract void setRadiusFAndNameFViews();

    abstract void setRadiusFAndNameFViews(ToolbarFacesState state);

    public abstract void defineSpyingItem();

    public abstract void onTransformerToolbar();

    public abstract void startIndicateThread();
