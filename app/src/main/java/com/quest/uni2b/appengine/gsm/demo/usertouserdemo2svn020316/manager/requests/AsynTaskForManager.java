package com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.manager.requests;
...
//import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.manager.alarm.AlarmServiceReceiver;
        ...
        switch (task) {
            case GET_REQUEST:
                ...
                if ((str != null) && !str.isEmpty()) {
                    ...
                    //_1 Toast.makeText(activityReload, "i've got it!", Toast.LENGTH_LONG).show();
                } else
