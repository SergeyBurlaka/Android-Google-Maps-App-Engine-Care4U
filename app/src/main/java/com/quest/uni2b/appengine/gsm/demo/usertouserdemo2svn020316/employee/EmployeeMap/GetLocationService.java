...
public class GetLocationService extends Service implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    private void raiseTheAlarm() {
        ...
        sendNotificationToM();
        TurnGPSNotification gpsNotification = new TurnGPSNotification(this); gpsNotification.ShowNotification();
    ...
    private void sendNotificationToM() {
        ...
        if (string_temp != "") {
            ...
            ControlMessageToM createMessage = new ControlMessageToM("@MATRIX_IS_EXIST", MessageConstant.GPS_DISABLE);
