...
package com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.employee.SpyViaGPSService;
...
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.controller.MessagesService.CreateEmployeeOutsideMessage;
...
public class GPSService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
   ...
   // private static final int NOTIFY_SPY_FOR_EMPLOYEE_ID = 101;
    ...
    public void onLocationChanged(Location location) {
      //  Toast.makeText(this,"GPSService latitude"+Double.toString(location.getLatitude()), Toast.LENGTH_SHORT).show();
    ...
    */
    private boolean checkGPS() {
        ...
        if ( !manager.isProviderEnabled( LocationManager.GPS_PROVIDER ) ) {
            ...
            TurnGPSNotification gpsNotification = new TurnGPSNotification(this);
    ...
    private void sendFailedSpyMessageToM() {
        ...
        if ( string_temp!="") {
            ...
            // taking loc data in our message in JSON FORMAT
            ControlMessageToM createMessage = new ControlMessageToM ("@MATRIX_IS_EXIST", MessageConstant.SPY_DID_NOT_START);
            String message = createMessage.getSpyMessage();
            // SEND_SPY_STATUS is not outside message.
            // It is for  sending different information about employee life.
            //ManagerEmail is not manager email. It is the message!
