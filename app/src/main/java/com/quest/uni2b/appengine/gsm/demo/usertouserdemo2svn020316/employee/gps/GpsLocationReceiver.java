...
public class GpsLocationReceiver extends BroadcastReceiver {
    ...
    private void raiseTheAlarm() {
        ...
        ToEmployeeTurnGPS gpsNotification = new ToEmployeeTurnGPS(context);
    ...
    private void sendNotificationToM(int messageToManager) {
        ...
        if (string_temp != "") {
            ...
            CreateControlMessageToM createMessage = new CreateControlMessageToM("@MATRIX_IS_EXIST", messageToManager);
