package com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.onreceive.service;
...
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.employee.gps.GetLocationService;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.employee.gps.GPSService;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.employee.geofence.GeofencingService;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.constants.MessageConstant;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.notifications.ToEmployeeReqInfo;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.notifications.ToEmployeeSpyBegin;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.notifications.ToManagerControl4E;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.notifications.ToManagerNewEmployee;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.notifications.ToManagerStatusSpy;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.onreceive.GcmIntentService;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.onreceive.service.parser.ParseEmployeeOutsideMessage;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.onreceive.service.parser.ParseSpyMessage;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.gcm.onreceive.MyServiseSetMarker;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.manager.ManagerCabinetListActivity;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.manager.employee.data.EmployeeLocation;
import com.quest.uni2b.appengine.gsm.demo.usertouserdemo2svn020316.manager.map.ReceiveMessageFlag;
...
public class MessageAgent {
    ...
    private ToEmployeeSpyBegin spyNotifToEmployee;
       ...
       //*** Message to employee
        case MessageConstant.KIND_SPY:
            ...
            try {
                ...
                ToEmployeeSpyBegin spyNotifToEmployee = new ToEmployeeSpyBegin( context,circleLabel );
        ...
        case MessageConstant.SIMPLE_MESSAGE:
           /* try {
             ...
             // _1  Toast.makeText(context,tempMessage, Toast.LENGTH_LONG).show();
            } catch (JSONException e) {
                e.printStackTrace();
            }*/
            break;
       ...
       //*** Message to manager
        //TODO_aborted set new name EXIT_ENTER_MESSAGE
            case MessageConstant.OUTSIDE_MESSAGE:
                try {
                        ToManagerStatusSpy showToManager = new ToManagerStatusSpy( parseMessage ( reader));
                    if ( isProblem4GPS(reader)|| ReceiveMessageFlag.noMore4Notification||getStatusSpy())return;
            ...
            case MessageConstant.NEW_EMPLOYEE_REQUEST:
                ...
                //    Toast.makeText(context,"I have new requestsn " + amountReq+" From "+emailFrom, Toast.LENGTH_LONG).show();
                        ToManagerNewEmployee toManagerNewEmployee = new ToManagerNewEmployee( context, emailFrom, amountReq);
                        toManagerNewEmployee.ShowNotification();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                break;
        ...
        String tempMssg = "NONE";
                ...
                ToEmployeeReqInfo toEmployeeReqInfo = new ToEmployeeReqInfo(context,emailFrom,tempMssg);
                toEmployeeReqInfo.ShowNotification();
                break;
    ...
    private void reportProblem() {
        ...
        // show special notification using ToManagerControl4E//
        ToManagerControl4E showToManager = new ToManagerControl4E(status4Control, emailFrom );
        showToManager.ShowNotification(context);
        // send to broadcast receiver  in user map
    ...
    private boolean isProblem4GPS(JSONObject reader) {
        ...
        try {
            ...
            //number must be from 4000 to 4999
