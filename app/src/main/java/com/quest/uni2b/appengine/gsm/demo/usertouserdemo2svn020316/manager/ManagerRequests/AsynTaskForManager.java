...
public class AsynTaskForManager extends AsyncTask<Void, Void, List<String>> {
   ...
   // private ManagerCabinetActivity activity;
   ...
   // private SharedPreferences pref;
    ...
    //<!--10june16_15:30
    //TODO_d+??: make constructor for DELETE_LIST_E_FROM_FRIEND request
    ...
    //<!--
    //TODO_done+08june16_14_50: make constructor deleteEmployee   parameters: MCabLActvt actvt, Employee email, manager id , asynTask deleteFromE
   ...
   //create constructor for spyiing asyng task  with manager id & user map context& email of employee  for toast
    //For GET_LOCATION TASK
   ...
   /*
    public  AsynTaskForManager (ManagerCabinetActivity activity, Long managerId, ArrayList<String> employeeEmails,String message, AsynTaskForManagerEnum enumTask) {
    ...
    /*
    //for confirm request
    public  AsynTaskForManager (ManagerCabinetActivity activity, Long managerId, ArrayList<String> employeeEmails, AsynTaskForManagerEnum enumTask) {
        this.activity = activity;
        this.managerId = managerId;
        this.employeeEmails = employeeEmails;
        this.task = enumTask;
   ...
   /*
    public AsynTaskForManager (ManagerCabinetActivity activity, Long managerId, AsynTaskForManagerEnum enumTask){
        this.activity = activity;
        this.managerId = managerId;
        this.task = enumTask;
    ...
    protected List<String> doInBackground(Void... params) {
       ...
       msg = "";
        ...
        switch (task) {
            ...
            //send special spy message with kind SPY = 7
            case SPY:
            ...
            //<!---
            //TODO_done+08june16_14_55: : make asynTask to server delete Employee from list
            ...
            //<!---10june16_15:30
           //TODO_d+??: wright request to server with parameters: managerId & list of employees
            //TODO_d+??: but make rebuild before
            ...
            //<!---18:00 17june16
            //TODO_d+:2---
            //TODO_d+27min: create asyn_task request to server stop spying just manager id & email of employee for request
            case STOP_SPY:
        ...
        switch (task) {
            case GET_REQUEST:
                ...
                if ((str != null) && !str.isEmpty()) {
                    ...
                    //old version
                  //  activity.createList();
                  //  activity.createRequestListActivity();
                    //new new new matrix reload matrix reload


                    //__________________
                    //activity.setListOfReqEmployees( str);
                } else
            ...
            case CONFIRM:
                ...
                for (String mssg : str) {
                    ...
                    //<---TO_DO_LIST 23.05.16
                    //change list of manager's friends dynamically
                    //#Urgently
            ...
            case GET_MANAGER:
                ...
                //    Toast.makeText(activityReload, resultManager.getEmail(), Toast.LENGTH_LONG).show();
                    ...
                    for (String email : emails){
                       ...
                       //<!---13:40 17june16
                        //TODO_d+: 1-------
                        //TODO_d+from 20min: get spying status from shared preference
                        //TODO_d+from 20min: set it in EmployeeOFM
            ...
            //TODO_done+3min reload cabinet manager list activity  t15:17
            //TODO_d+?? : case DELETE_LIST)E_FROM_FRIEND
            case DELETE_LIST_E_FROM_FRIEND:
            case DELETE_E_FROM_FRIEND:
            ...
            case STOP_SPY:
              ...
              Toast.makeText(userMapsActivity, msg, Toast.LENGTH_LONG).show();
               ...
               // userMapsActivity.reloadActivity();
